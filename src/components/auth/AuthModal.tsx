...
export const AuthModal: React.FC<AuthModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal Container */}
      <div className="relative w-full max-w-md bg-white rounded-[20px] border border-noir/[0.08] shadow-2xl p-6 sm:p-8 z-10 animate-in zoom-in-95 duration-200 overflow-hidden">
        {/* Top Accent Ribbon */}
        <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[#FFD3F6] via-[#D81B60] to-[#A80C42]" />

        {/* Close Button */}
        <button
          onClick={onClose}
          className="absolute top-4 right-4 w-8 h-8 rounded-full bg-noir/[0.04] hover:bg-noir/[0.08] flex items-center justify-center text-noir transition-colors"
        ...
        {submitted ? (
          ...
          <>
            ...
            {/* Mode Switcher Tabs */}
            <div className="grid grid-cols-2 p-1 bg-noir/[0.04] rounded-[12px] mb-5">
              <button
                type="button"
            ...
            <form onSubmit={handleSubmit} className="space-y-3.5">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2.5 rounded-[10px] bg-noir/[0.03] border border-noir/10 text-xs text-noir placeholder:text-noir/35 focus:outline-none focus:border-[#A80C42] focus:bg-white transition-all font-sans"
                    />
                  </div>
                </div>
              )}
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3 px-4 rounded-[12px] bg-noir hover:bg-[#A80C42] text-white font-mono text-xs font-bold uppercase tracking-wider shadow-md hover:shadow-lg transition-all duration-300 flex items-center justify-center gap-2 mt-4"
              >
                {loading ? (
